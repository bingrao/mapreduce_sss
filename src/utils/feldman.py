...
# Reference https://github.com/lorenzogentile404/feldman-verifiable-secret-sharing
...
# Compute elements of Z_p*, get all prime number between 1 and p
Z_p_star = []
for i in range(0, p):
    if math.gcd(i, p) == 1:  # Greatest common divisor
        Z_p_star.append(i)
